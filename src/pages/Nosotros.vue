    ...
    <div>
      <div class="page-header clear-filter" filter-color="blue">
        <parallax
          ...
          style="background-image:url('img/nosotrosE.png')"
        >
        </parallax>
        <div class="container">
          ...
          <h2 class="title">SOBRE NOSOTROS</h2><br><br><br><br><br>
          <p class="category">¿QUIÉNES SOMOS?</p>
          <div class="content">
        ...
        <div class="container">
          <div class="button-container">
            <tabs
              ...
              type="neutral"
            >
              <tab-pane title="Cleaning">
                <!-- <i slot="label" class="now-ui-icons design_image"></i> -->
                <img slot="label" class="n-logo" src="img/cleaning.png" alt="" />
              ...
              <tab-pane title="Innova">
                <!-- <i slot="label" class="now-ui-icons location_world"></i> -->
                <img slot="label" class="n-logo" src="img/innova.png" alt="" />
  
                <div class="col-md-10 ml-auto mr-auto">
                  <div class="row collections">
                    <div class="col-md-12">
                      <h3 class="title">INNOVA, CREA Y CONSTRUYE</h3>
                    </div>
                    <div class="col-md-4">
                      <p class="category">MISIÓN</p>
                      <h5 class="description">
